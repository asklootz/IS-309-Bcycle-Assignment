...
-- For bike_type-table:
insert into bergen.bike_type (bike_type_id, program_id, make, model, bike_type)
...
insert into bergen.bike_status (bike_status_id, bike_id, status, latitude, longitude, battery, remaining_range, total_distance, last_updated)
values ('bike_status_1', 'bergen_bike_e0001', 'available', 60.3913, 5.3221, 85, 50, 1200, 2026-03-20 22:18:31.199),
       ('bike_status_2', 'bergen_bike_e0002', 'in_use', 60.3920, 5.3230, 60, 35, 800, 2026-03-18 13:01:53.974),
       ('bike_status_3', 'bergen_bike_r0001', 'available', 60.3915, 5.3225, NULL, NULL, 500, 2026-03-18 13:00:50.215),
       ('bike_status_4', 'bergen_bike_s0001', 'maintenance', 60.3918, 5.3228, 67, 69, 300, 2026-03-16 11:04:23.273),
       ('bike_status_5', 'bergen_bike_c0001', 'available', 60.3922, 5.3232, NULL, NULL, 700, 2026-03-01 18:00:40.838);
...
values ('1', 'Dennis', 'Hayakawa', 'dennis.hayakawa@example.com', '1980-09-12', 'Motorsagens gate 1', 'Bergen', 5003, 'Hordaland', 14);
values ('2', 'Charli', 'XCX', 'charli.xcx@example.com', '1992-08-02', 'Bratgaten 2', 'Bergen', 5003, 'Hordaland', 8);

-- For user_auth-table:
insert into bergen.user_auth (user_id, hash_salt, pass_hash, email)
